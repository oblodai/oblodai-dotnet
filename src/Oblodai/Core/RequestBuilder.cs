...
/// </summary>
/// <param name="PublicId">Public id, sent as <see cref="SigningProtocol.HeaderPublicId"/>.</param>
...
public sealed record BuildInput
{
    ...
    /// <summary>Unix seconds; signed and sent as <see cref="SigningProtocol.HeaderTimestamp"/>.</summary>
